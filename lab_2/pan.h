...
#define _nstates0	81	/* Controller */
#define minseq0	0
#define maxseq0	79
#define _endstate0	80
...
typedef struct State {
	...
	#endif
#endif
	unsigned squirrel_present : 1;
	unsigned food_available : 1;
	uchar food_count;
	uchar refill_timer;
	uchar squirrel_timer;
	uchar feed_motor;
...
#define HAS_TRACK	0
/* hidden variable: */	uchar feeder_full;
/* hidden variable: */	uchar signal_light;
